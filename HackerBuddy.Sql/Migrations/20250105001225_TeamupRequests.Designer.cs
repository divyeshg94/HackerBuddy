...
namespace HackerBuddy.Sql.Migrations
{
    ...
    [Migration("20250105001225_TeamupRequests")]
    partial class TeamupRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HackerBuddy.Sql.Models.Person", b =>
                {
                    ...
                    b.Property<int?>("TeamupRequestID")
                        .HasColumnType("int");

                    b.Property<int?>("TeamupRequestID1")
                        .HasColumnType("int");

                    b.HasKey("PersonID");

                    b.HasIndex("TeamupRequestID");

                    b.HasIndex("TeamupRequestID1");
            ...
            modelBuilder.Entity("HackerBuddy.Sql.Models.TeamupRequest", b =>
                {
                    b.Property<int>("TeamupRequestID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TeamupRequestID"));
                    ...
                    b.HasKey("TeamupRequestID");

                    b.ToTable("TeamupRequests");
                });
            ...
            modelBuilder.Entity("HackerBuddy.Sql.Models.Person", b =>
                {
                    b.HasOne("HackerBuddy.Sql.Models.TeamupRequest", null)
                        .WithMany("Receiver")
                        .HasForeignKey("TeamupRequestID");

                    b.HasOne("HackerBuddy.Sql.Models.TeamupRequest", null)
                        .WithMany("Requester")
                        .HasForeignKey("TeamupRequestID1");
                });
